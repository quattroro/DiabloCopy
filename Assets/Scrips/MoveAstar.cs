...
//public class MoveAstar : Singleton<MoveAstar>
//{
...
//        Regions = new Region[(MapSize.x / RegionSize.x) * (MapSize.y / RegionSize.y)];
...
//        //하나의 리전에 8방향에 있는 리전들끼리 리전들끼리 움직일 수 있는지 확인한다
...
//    public bool CkechMoveable(Region region1, Region region2)
//    {
...
//            //Regions.Add(region);
//            Regions[_bottomRight.x + (_bottomRight.y * _size.x)] = region;
